...
## 기타
  해당 모델은 한국어 Pre-training 모델 연구와 실험을 위한 한국어 BERT Model입니다. 많은 데이터가 확보되었다면 더 나은 성능의 모델을 공개할 수 있었겠지만, 데이터 부족으로 한국어 위키데이터로 학습된 모델을 공유합니다. 모델 사용시 반드시 출처를 밝혀주시길 바랍니다.
  <br>
  <br>
